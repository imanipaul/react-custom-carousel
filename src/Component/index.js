                ...
                {this.props.dots &&
                    <div className="carousel-dots">
                        {this.state.slides.map(val => {
                            ...
                            return <div onClick={() => this.nextSlide(val)} key={val} id={`dot${val}`} className="dot"></div>;
                        })}
                    </div>}
